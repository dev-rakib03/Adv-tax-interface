                ...
                <form method="POST">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="frist_name" type="text" class="form-control needs-validation" required name="frist_name" autofocus>
                    </div>
                    <div class="form-group  col-6">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-4">
                      <label for="individual">Account Type</label>
                        <select id="individual" class="form-control needs-validation" required name="individual" autofocus>
